...
//     const tx = await contract.registerNTT(name, physicalAddress, wallet, ethers.parseUnits(initial, 18));
//     await tx.wait();
...
//   return (
//     <div className="p-6">
//       <h1 className="text-xl font-bold mb-4">Register NTT</h1>
//       <ConnectWallet onConnect={setSigner} />
//       <input placeholder="NTT Name" value={name} onChange={e => setName(e.target.value)} className="input" />
//       <input placeholder="Physical Address" value={physicalAddress} onChange={e => setPhysicalAddress(e.target.value)} className="input" />
//       <input placeholder="Wallet Address" value={wallet} onChange={e => setWallet(e.target.value)} className="input" />
//       <input placeholder="Initial Tokens" value={initial} onChange={e => setInitial(e.target.value)} className="input" />
